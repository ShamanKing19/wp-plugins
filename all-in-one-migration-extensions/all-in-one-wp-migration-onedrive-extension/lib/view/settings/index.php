			...
			<div class="ai1wm-holder">
				...
				<div class="ai1wm-field">
					...
					<?php else : ?>
						...
						<form method="post" action="<?php echo esc_url( AI1WMOE_REDIRECT_CREATE_URL ); ?>">
							...
							<input type="hidden" name="ai1wmoe_purchase_id" id="ai1wmoe-purchase-id" value="<?php echo esc_attr( get_option( 'ai1wmoe_plugin_key' ) ); ?>" />
							<input type="hidden" name="ai1wmoe_site_url" id="ai1wmoe-site-url" value="<?php echo esc_attr( site_url() ); ?>" />
							<input type="hidden" name="ai1wmoe_admin_email" id="ai1wmoe-admin-email" value="<?php echo esc_attr( get_option( 'admin_email' ) ); ?>" />
				...
				<div id="ai1wmoe-backups" class="ai1wm-holder">
					...
					<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php?action=ai1wmoe_onedrive_settings' ) ); ?>">
						<article class="ai1wmoe-article">
							...
							<p>
								<label for="ai1wmoe-onedrive-cron-timestamp">
									<?php _e( 'Backup time:', AI1WMOE_PLUGIN_NAME ); ?>
									<input type="text" name="ai1wmoe_onedrive_cron_timestamp" id="ai1wmoe-onedrive-cron-timestamp" value="<?php echo esc_attr( get_date_from_gmt( date( 'Y-m-d H:i:s', $onedrive_cron_timestamp ), 'g:i a' ) ); ?>" autocomplete="off" />
							...
							<p>
								<div class="ai1wm-field">
									<label for="ai1wmoe-onedrive-backups">
										...
										<input style="width: 4.5em;" type="number" min="0" name="ai1wmoe_onedrive_backups" id="ai1wmoe-onedrive-backups" value="<?php echo intval( $backups ); ?>" />
									</label>
								...
								<div class="ai1wm-field">
									<label for="ai1wmoe-onedrive-total">
										...
										<input style="width: 4.5em;" type="number" min="0" name="ai1wmoe_onedrive_total" id="ai1wmoe-onedrive-total" value="<?php echo intval( $total ); ?>" />
									</label>
								...
								<div class="ai1wm-field">
									<label for="ai1wmoe-onedrive-days">
										<?php _e( 'Remove backups older than ', AI1WMOE_PLUGIN_NAME ); ?>
										<input style="width: 4.5em;" type="number" min="0" name="ai1wmoe_onedrive_days" id="ai1wmoe-onedrive-days" value="<?php echo intval( $days ); ?>" />
									</label>
									<?php _e( 'days. <small>Default: <strong>0</strong> off</small>', AI1WMOE_PLUGIN_NAME ); ?>
								</div>
							</p>
						</article>
