...
class Ai1wmoe_OneDrive_Curl {
	...
	public function __construct() {
		if ( ! extension_loaded( 'curl' ) ) {
			throw new Ai1wmoe_Error_Exception( __( 'OneDrive Extension requires PHP cURL extension. <a href="https://help.servmask.com/knowledgebase/curl-missing-in-php-installation/" target="_blank">Technical details</a>', AI1WMOE_PLUGIN_NAME ) );
		}
	...
	public function make_request( $parse_as_json = false ) {
		...
		if ( $response === false ) {
			if ( ( $errno = curl_errno( $this->handler ) ) ) {
				throw new Ai1wmoe_Connect_Exception( sprintf( __( 'Unable to connect to OneDrive. Error code: %s. <a href="https://help.servmask.com/knowledgebase/onedrive-error-codes/#%s" target="_blank">Technical details</a>', AI1WMOE_PLUGIN_NAME ), $errno, $errno ) );
			}
		}
					...
					switch ( $data['error']['code'] ) {
						case 'UnknownError':
							if ( isset( $data['error']['message'] ) ) {
								throw new Ai1wmoe_Unknown_Error_Exception( sprintf( __( 'Your OneDrive account appears to be new. You must login and configure it first: <a href="https://onedrive.live.com/" target="_blank">https://onedrive.live.com/</a>. %s. <a href="https://help.servmask.com/knowledgebase/onedrive-error-codes/#UnknownError" target="_blank">Technical details</a>', AI1WMOE_PLUGIN_NAME ), $data['error']['message'] ) );
							} else {
								throw new Ai1wmoe_Unknown_Error_Exception( sprintf( __( 'Your OneDrive account appears to be new. You must login and configure it first: <a href="https://onedrive.live.com/" target="_blank">https://onedrive.live.com/</a>. Error code: %s. <a href="https://help.servmask.com/knowledgebase/onedrive-error-codes/#UnknownError" target="_blank">Technical details</a>', AI1WMOE_PLUGIN_NAME ), $data['error']['code'] ) );
							}

						default:
							if ( isset( $data['error']['message'] ) ) {
								throw new Ai1wmoe_Error_Exception( sprintf( __( '%s. <a href="https://help.servmask.com/knowledgebase/onedrive-error-codes/#%s" target="_blank">Technical details</a>', AI1WMOE_PLUGIN_NAME ), $data['error']['message'], $data['error']['code'] ) );
							} else {
								throw new Ai1wmoe_Error_Exception( sprintf( __( 'Error code: %s. <a href="https://help.servmask.com/knowledgebase/onedrive-error-codes/#%s" target="_blank">Technical details</a>', AI1WMOE_PLUGIN_NAME ), $data['error']['code'], $data['error']['code'] ) );
							}
					}
				}
			}
		...
		if ( $http_code >= 400 ) {
			if ( isset( $this->messages[ $http_code ] ) ) {
				throw new Ai1wmoe_Error_Exception( sprintf( __( '%s. <a href="https://help.servmask.com/knowledgebase/onedrive-error-codes/#%s" target="_blank">Technical details</a>', AI1WMOE_PLUGIN_NAME ), $this->messages[ $http_code ], $http_code ) );
			} else {
				throw new Ai1wmoe_Error_Exception( sprintf( __( 'Error code: %s. <a href="https://help.servmask.com/knowledgebase/onedrive-error-codes/#%s" target="_blank">Technical details</a>', AI1WMOE_PLUGIN_NAME ), $http_code, $http_code ) );
			}
		}
